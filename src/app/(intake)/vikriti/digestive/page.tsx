...
export default function VikritiDigestivePage() {
  ...
  const questions = (vikritiRules.categories as any).digestive.questions;
  ...
  return (
    <div className="space-y-6">
      <p className="text-sm text-amber-700">Rate your digestive symptoms over the last 2-8 weeks (0 = none, 3 = severe)</p>
